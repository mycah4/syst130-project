...
def location1_hangarbay():
    ...
    while True:
            ...
            if user_choice == "yes":
                ...
                create_audit_log("ITEM", "Got Mysterious Key") # makes log for key
...
def location2_bridge():
    ...
    if answer == "keyboard" or answer == "a keyboard":  # if correct answer you receive two different items
        ...
        create_audit_log("PUZZLE", "Solved bridge riddle") # creates audit log for bridge riddle
        return True
    ...
    while True:
        try:
            if "Keycard" in inventory and "Launch_Code" in inventory:
                ...
                create_audit_log("WIN", "Best ending")
                return True
                ...
                create_audit_log("END", "Average ending")
                return False
              ...
              create_audit_log("LOSS", "Worst ending")
                return False
